About django-parler-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-parler-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10373&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-parler-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-parler` can be installed with `conda`:
...
```
mamba install django-parler
```

It is possible to list all of the versions of `django-parler` available on your platform with `conda`:
...
```
mamba search django-parler --channel conda-forge
```
...
mamba repoquery search django-parler --channel conda-forge

# List packages depending on `django-parler`:
mamba repoquery whoneeds django-parler --channel conda-forge

# List dependencies of `django-parler`:
mamba repoquery depends django-parler --channel conda-forge
```
